            ...
            <section className="text-gray-400 body-font">
                <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    <div
                        ...
                        <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-200">Before they sold
                            out
                        ...
                        <div className="flex justify-center">
                            ...
                            <button
                                className="ml-4 inline-flex text-gray-400 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg">Button
                            </button>
                        </div>
                    </div>
